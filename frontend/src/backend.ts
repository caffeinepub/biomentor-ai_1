...
import type { ConversationHistory as _ConversationHistory, StudentProfile as _StudentProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addConversationTurn(arg0: ConversationTurn): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addConversationTurn(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addExtractedDoc(arg0: DocumentMetadata): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addExtractedDoc(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPracticeRecord(arg0: PracticeRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPracticeRecord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkTrialStatus(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkTrialStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getConversationHistory(): Promise<ConversationHistory | null> {
        if (this.processError) {
            try {
    ...
    async getPracticeRecords(): Promise<Array<PracticeRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPracticeRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudyMaterials(): Promise<Array<DocumentMetadata>> {
        if (this.processError) {
            try {
    ...
    async getWeakTopics(): Promise<Array<PracticeRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWeakTopics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeStudyMaterial(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeStudyMaterial(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startFreeTrial(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.startFreeTrial();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ConversationHistory]): ConversationHistory | null {
    return value.length === 0 ? null : value[0];
}
